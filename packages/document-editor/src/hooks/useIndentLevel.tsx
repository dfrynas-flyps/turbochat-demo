...
import { StatementTypes, TemplateStatement, isListStatement } from '../types/editor'
...
export const getMinimumIndentLevel = (statement: TemplateStatement): number => {
...
export const useIndentLevel = (statement: TemplateStatement): IndentLevelFeature => {
  ...
  const setIndentLevel = useCallback(
    (indentLevel: number) => {
