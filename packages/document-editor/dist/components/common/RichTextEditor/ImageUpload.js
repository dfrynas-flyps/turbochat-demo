...
const ImageInput = ({ handleFileChange }) => (_jsx(Input, { type: "file", onChange: handleFileChange, accept: "image/jpg,image/jpeg,image/png" }));
const apiAdapter = getApiAdapter();
const ImageUpload = ({ handleImageUpload, handleImageUploadIconClick = () => { }, editor, isReplace, }) => {
