    ...
    addKeyboardShortcuts() {
        return {
            Enter: ({ editor }) => {
                ...
                const { isCursorAtTheBeginning: withoutTypeoverIsCursorAtTheBeginning, isCursorAtTheEnd: withoutTypeoverIsCursorAtTheEnd, isCursorInTheMiddle, beforeCursorHtml, afterCursorHtml, beforeCursorJSON, } = getEditorDetailsBasedOnCursorPosition(editor);
...
//# sourceMappingURL=StatementEnterExtension.js.map