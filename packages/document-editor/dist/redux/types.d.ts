...
import { DeleteModalTypes, ProjectData, ProjectVariable, SavingState, StatementTypes, TemplateData, TemplatePrompts, TemplateStatement, VariableRegistryEntry } from '../types/editor';
...
export type ActiveVariable = VariableRegistryEntry & {
    variableDisplayId: string;
};
export interface TemplateState {
    ...
    newStatement: (Partial<TemplateStatement> & {
